...
clear && sleep 2
echo "Welcome to Talos Admin Console (Alpine Linux : \$(cat /etc/os-release | grep VERSION_ID | cut -d '=' -f2))"
[ "\$IP" != "" ] && echo "IP : \$IP"
echo ""
...
talosctl --talosconfig=/home/$USER/k1/v1.6.7/talosconfig config endpoint $VM_netid.$master_ip
